...
const calendarViewController_1 = require("../controllers/calendarViewController");
/**
 * @swagger
 * tags:
 *   name: Events
 ...
 */
router.get('/fr/evenements/filtrer', eventController_1.getFilteredEvents);
// Route pour les tests
router.get('/events/filter', eventController_1.getFilteredEvents);
/**
 * @swagger
 * /en/events/filter:
 *   get:
 ...
 */
router.get('/en/events/filter', eventController_1.getFilteredEvents);
/**
 * @swagger
 * /fr/evenements:
 *   get:
...
router.get('/fr/evenements', eventController_1.getEvents);
/**
 * @swagger
 * /en/events:
 *   get:
 ...
 *                 $ref: '#/components/schemas/Event'
 */
router.get('/en/events', eventController_1.getEvents);
/**
 * @swagger
 * /events/{id}:
 *   get:
 ...
 *         description: Accès refusé - Droits insuffisants selon l'API d'accès
 */
router.get('/calendar/day', calendarViewController_1.getEventsForDay);
/**
 * @swagger
 * /calendar/week:
 *   get:
 ...
 *         description: Accès refusé - Droits insuffisants selon l'API d'accès
 */
router.get('/calendar/week', calendarViewController_1.getEventsForWeek);
/**
 * @swagger
 * /calendar/month:
 *   get:
 ...
 *         description: Accès refusé - Droits insuffisants selon l'API d'accès
 */
router.get('/calendar/month', calendarViewController_1.getEventsForMonth);
