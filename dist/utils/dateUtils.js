...
exports.createUTCDateFromParts = createUTCDateFromParts;
exports.getUTCStartOfDay = getUTCStartOfDay;
exports.getUTCEndOfDay = getUTCEndOfDay;
exports.isValidUTCDate = isValidUTCDate;
exports.extractDatePart = extractDatePart;
exports.extractTimePart = extractTimePart;
exports.enrichEventWithDateTimeParts = enrichEventWithDateTimeParts;
/**
 ...
 * @returns Date en UTC
 */
function createUTCDateFromParts(year, month, day, hour = 0, minute = 0, second = 0) {
 ...
 */
function getUTCEndOfDay(year, month, day) {
 ...
 */
function enrichEventWithDateTimeParts(event, forceEnrich = false) {
    if (!event)
        return event;
